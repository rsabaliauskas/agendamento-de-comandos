...
exemplo de entrada de ação no comando.txt:
...
2026;;07;;x;;x;;x;;"notify-send" "-u" "critical" "-t" "0" "\"hora do cafe\"
 ...
 Depois de executado e estar rodando em loop lendo o aquivo comandos.txt, é possível acrescentar ou retirar entradas de datas/horas/comandos deste aquivo.
